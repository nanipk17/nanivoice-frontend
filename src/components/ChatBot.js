...
const defaultContextSchema = {
  role: 'system',
  content:
    'Your an helpfull assistant that understands users queries properly and gives them sensible answers in any language if you detect some other language make sure your writing them in english only',
}
